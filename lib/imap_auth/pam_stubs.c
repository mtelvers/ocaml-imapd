/* PAM C stubs for OCaml
   RFC 9051 IMAP server - Authentication via PAM

   Implements {{:https://datatracker.ietf.org/doc/html/rfc9051#section-6.2.3}RFC 9051 Section 6.2.3} LOGIN command authentication.
*/
